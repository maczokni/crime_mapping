...
```{r, fig.cap='Cartogram weightin each polygon (Local Authority) by the size of its electorate'}
ggplot() +
...
```{r, fig.cap='Dorling cartogram of LAs by electorate size'}
ggplot() +
...
```{r, fig.height=1, fig.cap='Legend for bivariate map'}
...
```{r, fig.cap='Bivariate choropleth map of voter turnout and % who voted to leave the EU'}
library(cowplot)
ggdraw() +
