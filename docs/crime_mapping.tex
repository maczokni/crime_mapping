...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nd }\OtherTok{\textless{}{-}}\NormalTok{ cc\_bars }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(name }\SpecialCharTok{==} \StringTok{"Night \& Day"}\NormalTok{) }

\NormalTok{nd\_buffer }\OtherTok{\textless{}{-}}\NormalTok{ bar\_buffer\_100 }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(name }\SpecialCharTok{==} \StringTok{"Night \& Day"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{st\_transform}\NormalTok{(}\DecValTok{4326}\NormalTok{) }\CommentTok{\# transform CRS}
...
\NormalTok{pal }\OtherTok{\textless{}{-}} \FunctionTok{colorBin}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"\#0868AC"}\NormalTok{, }\StringTok{"\#43A2CA"}\NormalTok{, }\StringTok{"\#7BCCC4"}\NormalTok{, }\StringTok{"\#BAE4BC"}\NormalTok{, }\StringTok{"\#F0F9E8"}\NormalTok{), }
                \AttributeTok{domain =}\NormalTok{ police\_distances}\SpecialCharTok{$}\NormalTok{distance\_km, }\AttributeTok{bins =}\NormalTok{ bins, }\AttributeTok{reverse =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{full\_map }\OtherTok{\textless{}{-}} \FunctionTok{leaflet}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{addTiles}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{addMarkers}\NormalTok{(}\AttributeTok{data =}\NormalTok{ comisarias\_sf, }\AttributeTok{icon =} \SpecialCharTok{\textasciitilde{}}\NormalTok{police\_icon, }\AttributeTok{group =} \StringTok{"Police stations"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{addPolygons}\NormalTok{(}\AttributeTok{data =}\NormalTok{ police\_distances[[}\DecValTok{1}\NormalTok{]], }\AttributeTok{fillColor =} \FunctionTok{pal}\NormalTok{(police\_distances}\SpecialCharTok{$}\NormalTok{distance\_km), }
              \AttributeTok{fillOpacity =} \FloatTok{0.8}\NormalTok{, }\AttributeTok{weight =}\DecValTok{0}\NormalTok{, }\AttributeTok{opacity =} \DecValTok{1}\NormalTok{, }\AttributeTok{color =} \StringTok{"transparent"}\NormalTok{, }\AttributeTok{group =} \StringTok{"Distances"}\NormalTok{,}
              \AttributeTok{highlight =} \FunctionTok{highlightOptions}\NormalTok{(}\AttributeTok{weight =} \FloatTok{2.5}\NormalTok{, }\AttributeTok{color =} \StringTok{"\#666"}\NormalTok{, }
                                           \AttributeTok{bringToFront =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{opacity=} \DecValTok{1}\NormalTok{), }
              \AttributeTok{popupOptions =} \FunctionTok{popupOptions}\NormalTok{(}\AttributeTok{autoPan =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{closeOnClick =} \ConstantTok{TRUE}\NormalTok{,}
                                          \AttributeTok{textOnly =}\NormalTok{ T)) }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{addLegend}\NormalTok{(}\AttributeTok{pal =}\NormalTok{ pal, }\AttributeTok{values =}\NormalTok{ (police\_distances}\SpecialCharTok{$}\NormalTok{distance\_km), }
             \AttributeTok{opacity =} \FloatTok{0.8}\NormalTok{, }\AttributeTok{title =} \StringTok{"Distance (Km)"}\NormalTok{, }\AttributeTok{position=} \StringTok{"bottomright"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
...
\FunctionTok{tm\_shape}\NormalTok{(manchester) }\SpecialCharTok{+} 
  \FunctionTok{tm\_fill}\NormalTok{(}\StringTok{"crimr1"}\NormalTok{, }\AttributeTok{style=}\StringTok{"jenks"}\NormalTok{, }\AttributeTok{palette=} \StringTok{"Reds"}\NormalTok{, }
          \AttributeTok{title =} \StringTok{"Crime per residential pop"}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.6}\NormalTok{) }\SpecialCharTok{+}
...
You can have a look at both these, and see which one you like. Feel free to use either in your future bivariate mapping adventures. Or construct your own, perhaps following the two additional ones provided by \protect\hyperlink{ref-Stevens_2015}{Stevens} (\protect\hyperlink{ref-Stevens_2015}{2015}), or some entirely news ones you may have constructued.
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-161-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-163-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-165-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-174-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-178-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-184-1.pdf}
...
\begin{verbatim}
##   |                                                     |                                             |   0%  |                                                     |=============================================| 100%
##   |                                                     |                                             |   0%  |                                                     |                                             |   1%  |                                                     |=                                            |   1%  |                                                     |=                                            |   2%  |                                                     |=                                            |   3%  |                                                     |==                                           |   4%  |                                                     |==                                           |   5%  |                                                     |==                                           |   6%  |                                                     |===                                          |   6%  |                                                     |===                                          |   7%  |                                                     |===                                          |   8%  |                                                     |====                                         |   8%  |                                                     |====                                         |   9%  |                                                     |====                                         |  10%  |                                                     |=====                                        |  12%  |                                                     |======                                       |  13%  |                                                     |======                                       |  14%  |                                                     |=======                                      |  14%  |                                                     |=======                                      |  15%  |                                                     |=======                                      |  16%  |                                                     |=======                                      |  17%  |                                                     |========                                     |  17%  |                                                     |========                                     |  18%  |                                                     |========                                     |  19%  |                                                     |=========                                    |  19%  |                                                     |=========                                    |  20%  |                                                     |=========                                    |  21%  |                                                     |==========                                   |  21%  |                                                     |==========                                   |  22%  |                                                     |==========                                   |  23%  |                                                     |===========                                  |  23%  |                                                     |===========                                  |  24%  |                                                     |===========                                  |  25%  |                                                     |============                                 |  26%  |                                                     |============                                 |  27%  |                                                     |============                                 |  28%  |                                                     |=============                                |  28%  |                                                     |=============                                |  29%  |                                                     |=============                                |  30%  |                                                     |==============                               |  30%  |                                                     |==============                               |  31%  |                                                     |==============                               |  32%  |                                                     |===============                              |  32%  |                                                     |===============                              |  33%  |                                                     |===============                              |  34%  |                                                     |================                             |  35%  |                                                     |================                             |  36%  |                                                     |================                             |  37%  |                                                     |=================                            |  37%  |                                                     |=================                            |  38%  |                                                     |=================                            |  39%  |                                                     |==================                           |  39%  |                                                     |==================                           |  40%  |                                                     |==================                           |  41%  |                                                     |===================                          |  41%  |                                                     |===================                          |  42%  |                                                     |===================                          |  43%  |                                                     |====================                         |  43%  |                                                     |====================                         |  44%  |                                                     |====================                         |  45%  |                                                     |=====================                        |  46%  |                                                     |=====================                        |  47%  |                                                     |=====================                        |  48%  |                                                     |======================                       |  48%  |                                                     |======================                       |  49%  |                                                     |======================                       |  50%  |                                                     |=======================                      |  50%  |                                                     |=======================                      |  51%  |                                                     |=======================                      |  52%  |                                                     |========================                     |  52%  |                                                     |========================                     |  53%  |                                                     |========================                     |  54%  |                                                     |=========================                    |  54%  |                                                     |=========================                    |  55%  |                                                     |=========================                    |  56%  |                                                     |=========================                    |  57%  |                                                     |==========================                   |  57%  |                                                     |==========================                   |  58%  |                                                     |==========================                   |  59%  |                                                     |===========================                  |  59%  |                                                     |===========================                  |  60%  |                                                     |===========================                  |  61%  |                                                     |============================                 |  61%  |                                                     |============================                 |  62%  |                                                     |============================                 |  63%  |                                                     |=============================                |  63%  |                                                     |=============================                |  64%  |                                                     |=============================                |  65%  |                                                     |=============================                |  66%  |                                                     |==============================               |  66%  |                                                     |==============================               |  67%  |                                                     |==============================               |  68%  |                                                     |===============================              |  68%  |                                                     |===============================              |  69%  |                                                     |===============================              |  70%  |                                                     |================================             |  70%  |                                                     |================================             |  71%  |                                                     |================================             |  72%  |                                                     |=================================            |  72%  |                                                     |=================================            |  73%  |                                                     |=================================            |  74%  |                                                     |==================================           |  75%  |                                                     |==================================           |  76%  |                                                     |==================================           |  77%  |                                                     |===================================          |  77%  |                                                     |===================================          |  78%  |                                                     |===================================          |  79%  |                                                     |====================================         |  79%  |                                                     |====================================         |  80%  |                                                     |====================================         |  81%  |                                                     |=====================================        |  81%  |                                                     |=====================================        |  82%  |                                                     |=====================================        |  83%  |                                                     |======================================       |  83%  |                                                     |======================================       |  84%  |                                                     |======================================       |  85%  |                                                     |=======================================      |  86%  |                                                     |=======================================      |  87%  |                                                     |=======================================      |  88%  |                                                     |========================================     |  88%  |                                                     |========================================     |  89%  |                                                     |========================================     |  90%  |                                                     |=========================================    |  90%  |                                                     |=========================================    |  91%  |                                                     |=========================================    |  92%  |                                                     |==========================================   |  92%  |                                                     |==========================================   |  93%  |                                                     |==========================================   |  94%  |                                                     |===========================================  |  94%  |                                                     |===========================================  |  95%  |                                                     |===========================================  |  96%  |                                                     |===========================================  |  97%  |                                                     |============================================ |  97%  |                                                     |============================================ |  98%  |                                                     |============================================ |  99%  |                                                     |=============================================|  99%  |                                                     |=============================================| 100%
\end{verbatim}
...
\includegraphics{crime_mapping_files/figure-latex/plot_data_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/create_window_6-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyc\_burg }\OtherTok{\textless{}{-}} \FunctionTok{st\_transform}\NormalTok{(nyc\_burg, }\DecValTok{32118}\NormalTok{) }\CommentTok{\#we must transform these too to match our window }
\NormalTok{sf\_nyc\_burg\_coords }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{unlist}\NormalTok{(nyc\_burg}\SpecialCharTok{$}\NormalTok{geometry), }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/hist_multiplicity_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/quadratcount_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/hextess_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/poisson_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/plot_density_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/plot_bandwidth_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/adaptive.density_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/kernels_6-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-189-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/raster_density_6-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pal }\OtherTok{\textless{}{-}} \FunctionTok{colorNumeric}\NormalTok{(}\StringTok{"Reds"}\NormalTok{, }\FunctionTok{values}\NormalTok{(r1),}
  \AttributeTok{na.color =} \StringTok{"transparent"}\NormalTok{) }\CommentTok{\#Create color palette}

\CommentTok{\#and then make map!}
\FunctionTok{leaflet}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{addTiles}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addProviderTiles}\NormalTok{(providers}\SpecialCharTok{$}\NormalTok{Stamen.TonerLite) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addRasterImage}\NormalTok{(r1, }\AttributeTok{colors =}\NormalTok{ pal, }\AttributeTok{opacity =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addLegend}\NormalTok{(}\AttributeTok{pal =}\NormalTok{ pal, }\AttributeTok{values =} \FunctionTok{values}\NormalTok{(r1),}
    \AttributeTok{title =} \StringTok{"Burglary map"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/leaflet_6-1.png}
...
\NormalTok{poisson }\OtherTok{\textless{}{-}} \FunctionTok{rpoispp}\NormalTok{(}\DecValTok{500}\NormalTok{)}
\NormalTok{poisson\_ppp }\OtherTok{\textless{}{-}} \FunctionTok{ppp}\NormalTok{(}\AttributeTok{x =}\NormalTok{ poisson}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{y =}\NormalTok{ poisson}\SpecialCharTok{$}\NormalTok{y)}
\FunctionTok{plot}\NormalTok{(poisson\_ppp)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-190-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-191-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-192-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-194-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# using osm data}
\NormalTok{kensington\_osm }\OtherTok{\textless{}{-}} \FunctionTok{opq}\NormalTok{(}\AttributeTok{bbox =}  \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{79.40772}\NormalTok{, }\FloatTok{43.64726}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{79.38672}\NormalTok{, }\FloatTok{43.65986}\NormalTok{ )) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{osmdata\_sf}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{osm\_poly2line}\NormalTok{()}
\NormalTok{kensington\_lines }\OtherTok{\textless{}{-}}\NormalTok{ kensington\_osm}\SpecialCharTok{$}\NormalTok{osm\_lines }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(highway)}
\CommentTok{\# using tigris}
\NormalTok{manhattan\_roads }\OtherTok{\textless{}{-}} \FunctionTok{roads}\NormalTok{(}\StringTok{"NY"}\NormalTok{, }\StringTok{"New York"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##   |                                                     |                                             |   0%  |                                                     |=                                            |   2%  |                                                     |===                                          |   7%  |                                                     |====                                         |   8%  |                                                     |====                                         |   9%  |                                                     |=====                                        |  10%  |                                                     |=====                                        |  11%  |                                                     |=======                                      |  15%  |                                                     |========                                     |  17%  |                                                     |=========                                    |  20%  |                                                     |=========                                    |  21%  |                                                     |==========                                   |  21%  |                                                     |==========                                   |  23%  |                                                     |===========                                  |  24%  |                                                     |===========                                  |  25%  |                                                     |============                                 |  27%  |                                                     |=============                                |  28%  |                                                     |=============                                |  29%  |                                                     |==============                               |  31%  |                                                     |==============                               |  32%  |                                                     |===============                              |  32%  |                                                     |===============                              |  33%  |                                                     |===============                              |  34%  |                                                     |================                             |  35%  |                                                     |================                             |  36%  |                                                     |=================                            |  38%  |                                                     |=================                            |  39%  |                                                     |==================                           |  41%  |                                                     |====================                         |  43%  |                                                     |====================                         |  45%  |                                                     |=====================                        |  46%  |                                                     |=====================                        |  48%  |                                                     |=======================                      |  50%  |                                                     |=======================                      |  51%  |                                                     |========================                     |  54%  |                                                     |==========================                   |  57%  |                                                     |===========================                  |  60%  |                                                     |=============================                |  63%  |                                                     |==============================               |  66%  |                                                     |===============================              |  70%  |                                                     |=================================            |  73%  |                                                     |===================================          |  77%  |                                                     |====================================         |  81%  |                                                     |======================================       |  84%  |                                                     |===========================================  |  95%  |                                                     |=============================================| 100%
\end{verbatim}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-195-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-196-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/plotlinestops-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bk\_sntns\_list }\OtherTok{\textless{}{-}} \FunctionTok{paste}\NormalTok{(bakerloo\_stops}\SpecialCharTok{$}\NormalTok{stn\_name, }\AttributeTok{collapse =} \StringTok{"|"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{parts }\OtherTok{\textless{}{-}} \FunctionTok{st\_split}\NormalTok{(bakerloo\_line, }\FunctionTok{st\_combine}\NormalTok{(bakerloo\_stops}\SpecialCharTok{$}\NormalTok{geometry)) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{st\_collection\_extract}\NormalTok{(}\StringTok{"LINESTRING"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/plotalltogether-1.pdf}
...
\NormalTok{sections\_freq }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{table}\NormalTok{(bline\_segments))}
\CommentTok{\#make sure id is numeric}
\NormalTok{sections\_freq}\SpecialCharTok{$}\NormalTok{bline\_segments }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(sections\_freq}\SpecialCharTok{$}\NormalTok{bline\_segments))}
\CommentTok{\#join to sections object and replace NAs with 0s}
\NormalTok{bakerloo\_sections }\OtherTok{\textless{}{-}} \FunctionTok{left\_join}\NormalTok{(bakerloo\_sections, sections\_freq, }\AttributeTok{by =} \FunctionTok{c}\NormalTok{(}\StringTok{"section"} \OtherTok{=} \StringTok{"bline\_segments"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Freq =} \FunctionTok{replace\_na}\NormalTok{(Freq, }\DecValTok{0}\NormalTok{)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# create midpoint object}
\NormalTok{midpoint\_crimes }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(bakerloo\_sections}\SpecialCharTok{$}\NormalTok{Freq)}


\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_sf}\NormalTok{(}\AttributeTok{data =}\NormalTok{ bakerloo\_sections, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{colour =}\NormalTok{ Freq), }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_sf}\NormalTok{(}\AttributeTok{data =}\NormalTok{ bakerloo\_stops) }\SpecialCharTok{+} 
  \FunctionTok{theme\_void}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{scale\_colour\_gradient2}\NormalTok{(}\AttributeTok{name =} \StringTok{"Number of crimes"}\NormalTok{, }
                         \AttributeTok{midpoint =}\NormalTok{ midpoint\_crimes,}
                         \AttributeTok{low =} \StringTok{"\#ffffcc"}\NormalTok{, }\AttributeTok{mid =} \StringTok{"\#fd8d3c"}\NormalTok{, }\AttributeTok{high =} \StringTok{"\#800026"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/countmap-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bakerloo\_sections}\SpecialCharTok{$}\NormalTok{length }\OtherTok{\textless{}{-}} \FunctionTok{st\_length}\NormalTok{(bakerloo\_sections)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m }\OtherTok{\textless{}{-}}\NormalTok{ bakerloo\_sections}\SpecialCharTok{$}\NormalTok{Freq }\SpecialCharTok{/}\NormalTok{ bakerloo\_sections}\SpecialCharTok{$}\NormalTok{length}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m)}
\NormalTok{midpoint\_rates }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m)}
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_sf}\NormalTok{(}\AttributeTok{data =}\NormalTok{ bakerloo\_sections, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{colour =}\NormalTok{ crime\_per\_m), }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_sf}\NormalTok{(}\AttributeTok{data =}\NormalTok{ bakerloo\_stops) }\SpecialCharTok{+} 
  \FunctionTok{theme\_void}\NormalTok{() }\SpecialCharTok{+} 
  ...
  \FunctionTok{scale\_colour\_gradient2}\NormalTok{(}\AttributeTok{name =} \StringTok{"Rate of crimes per meter"}\NormalTok{, }
                         \AttributeTok{midpoint =}\NormalTok{ midpoint\_rates,}
                         \AttributeTok{low =} \StringTok{"\#ffffcc"}\NormalTok{, }\AttributeTok{mid =} \StringTok{"\#fd8d3c"}\NormalTok{, }\AttributeTok{high =} \StringTok{"\#800026"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/ratemap-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/ratemapwthickness-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bk\_lorenz }\OtherTok{\textless{}{-}} \FunctionTok{Lc}\NormalTok{(bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-204-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ineq}\NormalTok{(bakerloo\_sections}\SpecialCharTok{$}\NormalTok{crime\_per\_m, }\AttributeTok{type=}\StringTok{"Gini"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-206-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bakerloo\_stops}\SpecialCharTok{$}\NormalTok{violent\_crime\_rate }\OtherTok{\textless{}{-}}\NormalTok{ bakerloo\_stops}\SpecialCharTok{$}\NormalTok{num\_violent\_crimes}\SpecialCharTok{/}
\NormalTok{  bakerloo\_stops}\SpecialCharTok{$}\NormalTok{total\_pax }\SpecialCharTok{*} \DecValTok{10000}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-208-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-210-1.pdf}
...
\begin{verbatim}
##   |                                                     |                                             |   0%  |                                                     |                                             |   1%  |                                                     |=                                            |   1%  |                                                     |=                                            |   2%  |                                                     |==                                           |   5%  |                                                     |===                                          |   6%  |                                                     |===                                          |   7%  |                                                     |===                                          |   8%  |                                                     |====                                         |   8%  |                                                     |====                                         |   9%  |                                                     |====                                         |  10%  |                                                     |=====                                        |  10%  |                                                     |=====                                        |  11%  |                                                     |=====                                        |  12%  |                                                     |======                                       |  12%  |                                                     |======                                       |  13%  |                                                     |======                                       |  14%  |                                                     |=======                                      |  14%  |                                                     |=======                                      |  15%  |                                                     |=======                                      |  16%  |                                                     |=======                                      |  17%  |                                                     |========                                     |  17%  |                                                     |========                                     |  18%  |                                                     |========                                     |  19%  |                                                     |=========                                    |  19%  |                                                     |=========                                    |  20%  |                                                     |=========                                    |  21%  |                                                     |==========                                   |  21%  |                                                     |==========                                   |  22%  |                                                     |==========                                   |  23%  |                                                     |===========                                  |  23%  |                                                     |===========                                  |  24%  |                                                     |===========                                  |  25%  |                                                     |============                                 |  26%  |                                                     |============                                 |  27%  |                                                     |============                                 |  28%  |                                                     |=============                                |  28%  |                                                     |=============                                |  29%  |                                                     |=============                                |  30%  |                                                     |==============                               |  30%  |                                                     |==============                               |  31%  |                                                     |==============                               |  32%  |                                                     |===============                              |  32%  |                                                     |===============                              |  33%  |                                                     |===============                              |  34%  |                                                     |================                             |  35%  |                                                     |================                             |  36%  |                                                     |================                             |  37%  |                                                     |=================                            |  37%  |                                                     |=================                            |  38%  |                                                     |=================                            |  39%  |                                                     |==================                           |  39%  |                                                     |==================                           |  40%  |                                                     |==================                           |  41%  |                                                     |===================                          |  41%  |                                                     |===================                          |  42%  |                                                     |===================                          |  43%  |                                                     |====================                         |  43%  |                                                     |====================                         |  44%  |                                                     |====================                         |  45%  |                                                     |=====================                        |  46%  |                                                     |=====================                        |  47%  |                                                     |=====================                        |  48%  |                                                     |======================                       |  48%  |                                                     |======================                       |  49%  |                                                     |======================                       |  50%  |                                                     |=======================                      |  50%  |                                                     |=======================                      |  51%  |                                                     |=======================                      |  52%  |                                                     |========================                     |  52%  |                                                     |========================                     |  53%  |                                                     |========================                     |  54%  |                                                     |=========================                    |  54%  |                                                     |=========================                    |  55%  |                                                     |=========================                    |  56%  |                                                     |=========================                    |  57%  |                                                     |==========================                   |  57%  |                                                     |==========================                   |  58%  |                                                     |===========================                  |  59%  |                                                     |===========================                  |  60%  |                                                     |===========================                  |  61%  |                                                     |============================                 |  61%  |                                                     |============================                 |  62%  |                                                     |============================                 |  63%  |                                                     |=============================                |  63%  |                                                     |=============================                |  64%  |                                                     |=============================                |  65%  |                                                     |=============================                |  66%  |                                                     |==============================               |  66%  |                                                     |==============================               |  67%  |                                                     |==============================               |  68%  |                                                     |===============================              |  68%  |                                                     |===============================              |  69%  |                                                     |===============================              |  70%  |                                                     |================================             |  70%  |                                                     |================================             |  71%  |                                                     |================================             |  72%  |                                                     |=================================            |  72%  |                                                     |=================================            |  73%  |                                                     |=================================            |  74%  |                                                     |==================================           |  74%  |                                                     |==================================           |  75%  |                                                     |==================================           |  76%  |                                                     |==================================           |  77%  |                                                     |===================================          |  77%  |                                                     |===================================          |  78%  |                                                     |===================================          |  79%  |                                                     |====================================         |  79%  |                                                     |====================================         |  80%  |                                                     |====================================         |  81%  |                                                     |=====================================        |  81%  |                                                     |=====================================        |  82%  |                                                     |=====================================        |  83%  |                                                     |======================================       |  83%  |                                                     |======================================       |  84%  |                                                     |======================================       |  85%  |                                                     |=======================================      |  86%  |                                                     |=======================================      |  87%  |                                                     |=======================================      |  88%  |                                                     |========================================     |  88%  |                                                     |========================================     |  89%  |                                                     |========================================     |  90%  |                                                     |=========================================    |  90%  |                                                     |=========================================    |  91%  |                                                     |=========================================    |  92%  |                                                     |==========================================   |  92%  |                                                     |==========================================   |  93%  |                                                     |==========================================   |  94%  |                                                     |===========================================  |  94%  |                                                     |===========================================  |  95%  |                                                     |===========================================  |  96%  |                                                     |===========================================  |  97%  |                                                     |============================================ |  97%  |                                                     |============================================ |  98%  |                                                     |============================================ |  99%  |                                                     |=============================================|  99%  |                                                     |=============================================| 100%
\end{verbatim}
...
\begin{verbatim}
##   |                                                     |                                             |   0%  |                                                     |                                             |   1%  |                                                     |=                                            |   1%  |                                                     |=                                            |   2%  |                                                     |=                                            |   3%  |                                                     |==                                           |   3%  |                                                     |==                                           |   4%  |                                                     |==                                           |   5%  |                                                     |===                                          |   6%  |                                                     |===                                          |   7%  |                                                     |====                                         |   8%  |                                                     |====                                         |   9%  |                                                     |====                                         |  10%  |                                                     |=====                                        |  10%  |                                                     |=====                                        |  11%  |                                                     |=====                                        |  12%  |                                                     |======                                       |  12%  |                                                     |======                                       |  13%  |                                                     |======                                       |  14%  |                                                     |=======                                      |  15%  |                                                     |=======                                      |  16%  |                                                     |=======                                      |  17%  |                                                     |========                                     |  17%  |                                                     |========                                     |  18%  |                                                     |========                                     |  19%  |                                                     |=========                                    |  19%  |                                                     |=========                                    |  20%  |                                                     |=========                                    |  21%  |                                                     |==========                                   |  21%  |                                                     |==========                                   |  22%  |                                                     |==========                                   |  23%  |                                                     |===========                                  |  23%  |                                                     |===========                                  |  24%  |                                                     |===========                                  |  25%  |                                                     |============                                 |  26%  |                                                     |============                                 |  27%  |                                                     |============                                 |  28%  |                                                     |=============                                |  28%  |                                                     |=============                                |  29%  |                                                     |=============                                |  30%  |                                                     |==============                               |  30%  |                                                     |==============                               |  31%  |                                                     |==============                               |  32%  |                                                     |===============                              |  33%  |                                                     |===============                              |  34%  |                                                     |================                             |  35%  |                                                     |================                             |  36%  |                                                     |================                             |  37%  |                                                     |=================                            |  37%  |                                                     |=================                            |  38%  |                                                     |=================                            |  39%  |                                                     |==================                           |  39%  |                                                     |==================                           |  40%  |                                                     |==================                           |  41%  |                                                     |===================                          |  41%  |                                                     |===================                          |  42%  |                                                     |===================                          |  43%  |                                                     |====================                         |  43%  |                                                     |====================                         |  44%  |                                                     |====================                         |  45%  |                                                     |=====================                        |  46%  |                                                     |=====================                        |  47%  |                                                     |=====================                        |  48%  |                                                     |======================                       |  48%  |                                                     |======================                       |  49%  |                                                     |======================                       |  50%  |                                                     |=======================                      |  50%  |                                                     |=======================                      |  51%  |                                                     |=======================                      |  52%  |                                                     |========================                     |  52%  |                                                     |========================                     |  53%  |                                                     |========================                     |  54%  |                                                     |=========================                    |  55%  |                                                     |=========================                    |  56%  |                                                     |=========================                    |  57%  |                                                     |==========================                   |  57%  |                                                     |==========================                   |  58%  |                                                     |==========================                   |  59%  |                                                     |===========================                  |  59%  |                                                     |===========================                  |  60%  |                                                     |===========================                  |  61%  |                                                     |============================                 |  61%  |                                                     |============================                 |  62%  |                                                     |============================                 |  63%  |                                                     |=============================                |  63%  |                                                     |=============================                |  64%  |                                                     |=============================                |  65%  |                                                     |==============================               |  66%  |                                                     |==============================               |  67%  |                                                     |==============================               |  68%  |                                                     |===============================              |  68%  |                                                     |===============================              |  69%  |                                                     |===============================              |  70%  |                                                     |================================             |  70%  |                                                     |================================             |  71%  |                                                     |================================             |  72%  |                                                     |=================================            |  72%  |                                                     |=================================            |  73%  |                                                     |=================================            |  74%  |                                                     |==================================           |  75%  |                                                     |==================================           |  76%  |                                                     |==================================           |  77%  |                                                     |===================================          |  77%  |                                                     |===================================          |  78%  |                                                     |===================================          |  79%  |                                                     |====================================         |  79%  |                                                     |====================================         |  80%  |                                                     |====================================         |  81%  |                                                     |=====================================        |  81%  |                                                     |=====================================        |  82%  |                                                     |=====================================        |  83%  |                                                     |======================================       |  84%  |                                                     |======================================       |  85%  |                                                     |=======================================      |  86%  |                                                     |=======================================      |  87%  |                                                     |=======================================      |  88%  |                                                     |========================================     |  88%  |                                                     |========================================     |  89%  |                                                     |========================================     |  90%  |                                                     |=========================================    |  90%  |                                                     |=========================================    |  91%  |                                                     |=========================================    |  92%  |                                                     |==========================================   |  92%  |                                                     |==========================================   |  93%  |                                                     |==========================================   |  94%  |                                                     |===========================================  |  95%  |                                                     |===========================================  |  96%  |                                                     |===========================================  |  97%  |                                                     |============================================ |  97%  |                                                     |============================================ |  98%  |                                                     |============================================ |  99%  |                                                     |=============================================|  99%  |                                                     |=============================================| 100%
\end{verbatim}
...
\includegraphics{crime_mapping_files/figure-latex/getchicagodata-1.pdf}
...
\NormalTok{chicago\_viol }\OtherTok{\textless{}{-}} \FunctionTok{st\_transform}\NormalTok{(chicago\_viol, }\DecValTok{6454}\NormalTok{)}
\NormalTok{chicago\_viol}\SpecialCharTok{$}\NormalTok{month }\OtherTok{\textless{}{-}} \FunctionTok{month}\NormalTok{(chicago\_viol}\SpecialCharTok{$}\NormalTok{date\_single)}
\NormalTok{chicago\_viol }\OtherTok{\textless{}{-}} \FunctionTok{filter}\NormalTok{(chicago\_viol, month }\SpecialCharTok{\%in\%}\NormalTok{ (}\DecValTok{6}\SpecialCharTok{:}\DecValTok{8}\NormalTok{))}
\NormalTok{chi\_viol\_coord }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{unlist}\NormalTok{(chicago\_viol}\SpecialCharTok{$}\NormalTok{geometry), }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =}\NormalTok{ T)}
\NormalTok{w }\OtherTok{\textless{}{-}} \FunctionTok{as.owin}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{356456.4}\NormalTok{, }\FloatTok{358379.1}\NormalTok{,}\FloatTok{565240.1}\NormalTok{, }\FloatTok{567094.3}\NormalTok{))}
\NormalTok{chi\_viol\_ppp }\OtherTok{\textless{}{-}} \FunctionTok{ppp}\NormalTok{(}\AttributeTok{x =}\NormalTok{ chi\_viol\_coord[,}\DecValTok{1}\NormalTok{], }\AttributeTok{y =}\NormalTok{ chi\_viol\_coord[,}\DecValTok{2}\NormalTok{],}
                        \AttributeTok{window =}\NormalTok{ w, }\AttributeTok{check =}\NormalTok{ T)}
\NormalTok{chi\_viol\_ppp }\OtherTok{\textless{}{-}} \FunctionTok{as.ppp}\NormalTok{(chi\_viol\_ppp)}
\CommentTok{\#we know there is multiplicity so we will add this as a mark}
\FunctionTok{marks}\NormalTok{(chi\_viol\_ppp) }\OtherTok{\textless{}{-}} \FunctionTok{multiplicity}\NormalTok{(chi\_viol\_ppp)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-212-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-216-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{delitos }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"data/delitos.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(tipo\_delito }\SpecialCharTok{==} \StringTok{"Homicidio Doloso"}\NormalTok{)}
\NormalTok{delitos}\SpecialCharTok{$}\NormalTok{year }\OtherTok{\textless{}{-}} \FunctionTok{year}\NormalTok{(delitos}\SpecialCharTok{$}\NormalTok{fecha)}
\NormalTok{delitos }\OtherTok{\textless{}{-}} \FunctionTok{filter}\NormalTok{(delitos, year }\SpecialCharTok{==} \StringTok{"2016"} \SpecialCharTok{|}\NormalTok{ year }\SpecialCharTok{==} \StringTok{"2017"}\NormalTok{)}
\NormalTok{delitos\_sf }\OtherTok{\textless{}{-}} \FunctionTok{st\_as\_sf}\NormalTok{(delitos,                                     }
                      \AttributeTok{coords =} \FunctionTok{c}\NormalTok{(}\StringTok{"longitud"}\NormalTok{, }\StringTok{"latitud"}\NormalTok{),}
                      \AttributeTok{crs =} \DecValTok{4326}\NormalTok{)}
\NormalTok{delitos\_sf }\OtherTok{\textless{}{-}} \FunctionTok{st\_transform}\NormalTok{(delitos\_sf, }\DecValTok{5343}\NormalTok{)}
\NormalTok{buenos\_aires }\OtherTok{\textless{}{-}} \FunctionTok{st\_read}\NormalTok{(}\StringTok{"data/buenos\_aires.geojson"}\NormalTok{, }\AttributeTok{quiet =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-219-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{window }\OtherTok{\textless{}{-}}\NormalTok{ spatstat.geom}\SpecialCharTok{::}\FunctionTok{as.owin}\NormalTok{(sf}\SpecialCharTok{::}\FunctionTok{st\_geometry}\NormalTok{(buenos\_aires))}
\FunctionTok{unitname}\NormalTok{(window) }\OtherTok{\textless{}{-}} \StringTok{"Meter"}
\NormalTok{delitos\_coords }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{unlist}\NormalTok{(delitos\_sf}\SpecialCharTok{$}\NormalTok{geometry), }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =}\NormalTok{ T)}
\NormalTok{delitos\_ppp }\OtherTok{\textless{}{-}} \FunctionTok{ppp}\NormalTok{(}\AttributeTok{x =}\NormalTok{ delitos\_coords[,}\DecValTok{1}\NormalTok{], }\AttributeTok{y =}\NormalTok{ delitos\_coords[,}\DecValTok{2}\NormalTok{],}
                   \AttributeTok{window =}\NormalTok{ window, }\AttributeTok{check =}\NormalTok{ T)}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{200}\NormalTok{)}
\NormalTok{delitos\_jit }\OtherTok{\textless{}{-}} \FunctionTok{rjitter}\NormalTok{(delitos\_ppp, }\AttributeTok{retry=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{nsim=}\DecValTok{1}\NormalTok{, }
                       \AttributeTok{radius =} \DecValTok{2}\NormalTok{, }\AttributeTok{drop=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-221-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-222-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-223-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-224-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-225-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-226-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-227-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-228-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-230-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/adjacencyfigure-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-231-1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nb\_queen }\OtherTok{\textless{}{-}} \FunctionTok{poly2nb}\NormalTok{(cc\_burglary\_sp, }\AttributeTok{row.names=}\NormalTok{cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{code)}
\FunctionTok{class}\NormalTok{(nb\_queen)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-235-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-243-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-251-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{moran.test}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_queen)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Adapted from Brunsdon and Comber (2015)}
\NormalTok{moran\_range }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(lw) \{}
\NormalTok{  wmat }\OtherTok{\textless{}{-}} \FunctionTok{listw2mat}\NormalTok{(lw)}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{range}\NormalTok{(}\FunctionTok{eigen}\NormalTok{((wmat }\SpecialCharTok{+} \FunctionTok{t}\NormalTok{(wmat))}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\SpecialCharTok{$}\NormalTok{values))}
\NormalTok{\}}
\FunctionTok{moran\_range}\NormalTok{(lw\_queen)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{burg\_moranmc\_results }\OtherTok{\textless{}{-}} \FunctionTok{moran.mc}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_queen, }\AttributeTok{nsim=}\DecValTok{99}\NormalTok{)}

\NormalTok{burg\_moranmc\_results}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{moran.test}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_distance)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{moran.test}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_k3)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{moran.test}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_inverse\_d)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{moran.plot}\NormalTok{(}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{scale}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary)), wm\_queen\_rs)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-258-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{geary.test}\NormalTok{(cc\_burglary\_sp}\SpecialCharTok{$}\NormalTok{burglary, lw\_queen)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-267-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-268-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-269-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-270-1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Perform the local G analysis (Getis{-}Ord GI*)}
\NormalTok{grid\_cc}\SpecialCharTok{$}\NormalTok{G\_hotspot\_z }\OtherTok{\textless{}{-}} \FunctionTok{as.vector}\NormalTok{(}\FunctionTok{localG}\NormalTok{(grid\_cc}\SpecialCharTok{$}\NormalTok{layer, lw\_queen\_cc))}
\CommentTok{\# Summarise results}
\FunctionTok{summary}\NormalTok{(grid\_cc}\SpecialCharTok{$}\NormalTok{G\_hotspot\_z)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_values\_lg }\OtherTok{\textless{}{-}} \DecValTok{2} \SpecialCharTok{*} \FunctionTok{pnorm}\NormalTok{(}\FunctionTok{abs}\NormalTok{(}\FunctionTok{c}\NormalTok{(grid\_cc}\SpecialCharTok{$}\NormalTok{G\_hotspot\_z)), }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{p\_values\_lgmc }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(p\_values\_lg, }
              \FunctionTok{p.adjust}\NormalTok{(p\_values\_lg, }\StringTok{"bonferroni"}\NormalTok{), }
              \FunctionTok{p.adjust}\NormalTok{(p\_values\_lg, }\StringTok{"fdr"}\NormalTok{), }
              \FunctionTok{p.adjust}\NormalTok{(p\_values\_lg, }\StringTok{"BY"}\NormalTok{))}
\FunctionTok{colnames}\NormalTok{(p\_values\_lgmc) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"None"}\NormalTok{, }\StringTok{"Bonferroni"}\NormalTok{, }
                           \StringTok{"False Discovery Rate"}\NormalTok{, }\StringTok{"BY (2001)"}\NormalTok{)}
\FunctionTok{apply}\NormalTok{(p\_values\_lgmc, }\DecValTok{2}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(x }\SpecialCharTok{\textless{}} \FloatTok{0.05}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# convert to simple features object}
\NormalTok{grid\_cc\_sf }\OtherTok{\textless{}{-}} \FunctionTok{st\_as\_sf}\NormalTok{(grid\_cc)}
\CommentTok{\# Creates p values for Bonferroni adjustment}
\NormalTok{grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{G\_hotspot\_bonf }\OtherTok{\textless{}{-}} \FunctionTok{p.adjust}\NormalTok{(p\_values\_lg, }\StringTok{"bonferroni"}\NormalTok{)}
\CommentTok{\# Create character vector based on Z score and p values }
\NormalTok{grid\_cc\_sf }\OtherTok{\textless{}{-}}\NormalTok{ grid\_cc\_sf }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hotspot =} \FunctionTok{case\_when}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{G\_hotspot\_bonf }\SpecialCharTok{\textless{}} \FloatTok{0.05} \SpecialCharTok{\&} 
\NormalTok{                               grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{G\_hotspot\_z }\SpecialCharTok{\textgreater{}} \DecValTok{0} \SpecialCharTok{\textasciitilde{}} \StringTok{"Hot spot"}\NormalTok{,}
\NormalTok{                             grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{G\_hotspot\_bonf }\SpecialCharTok{\textless{}} \FloatTok{0.05} \SpecialCharTok{\&} 
\NormalTok{                               grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{G\_hotspot\_z }\SpecialCharTok{\textless{}} \DecValTok{0} \SpecialCharTok{\textasciitilde{}} \StringTok{"Cold spot"}\NormalTok{,}
                             \ConstantTok{TRUE} \SpecialCharTok{\textasciitilde{}} \StringTok{"Not significant"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{hotspot)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# create row standardised weights}
\NormalTok{lw\_queen\_rs }\OtherTok{\textless{}{-}}  \FunctionTok{nb2listw}\NormalTok{(nb\_queen\_cc, }\AttributeTok{style=}\StringTok{\textquotesingle{}W\textquotesingle{}}\NormalTok{)}

\CommentTok{\# build Moran\textquotesingle{}s scatterplot}
\NormalTok{m\_plot\_burglary }\OtherTok{\textless{}{-}} \FunctionTok{moran.plot}\NormalTok{(}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{scale}\NormalTok{(grid\_cc}\SpecialCharTok{$}\NormalTok{layer)), }
\NormalTok{                              lw\_queen\_rs, }\AttributeTok{cex=}\DecValTok{1}\NormalTok{, }\AttributeTok{pch=}\StringTok{"."}\NormalTok{, }
                              \AttributeTok{xlab=}\StringTok{"burglary count"}\NormalTok{,  }\AttributeTok{ylab=}\StringTok{"lagged burglary count"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-278-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# We extract the influence measure and place it in the sp object}
\NormalTok{grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{lm\_hat }\OtherTok{\textless{}{-}}\NormalTok{ m\_plot\_burglary}\SpecialCharTok{$}\NormalTok{hat}
\CommentTok{\# Then we can plot this measure of influence}
\FunctionTok{tm\_shape}\NormalTok{(grid\_cc\_sf) }\SpecialCharTok{+} \FunctionTok{tm\_fill}\NormalTok{(}\StringTok{"lm\_hat"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-279-1.png}

To compute the local Moran's I we can use the \texttt{localmoran()} function from the \texttt{spdep} package.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{locm\_burglary }\OtherTok{\textless{}{-}} \FunctionTok{localmoran}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{layer, lw\_queen\_rs, }\AttributeTok{alternative =} \StringTok{"two.sided"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{locm\_burglary\_perm }\OtherTok{\textless{}{-}} \FunctionTok{localmoran\_perm}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{layer, }
\NormalTok{                                      lw\_queen\_rs, }
                                      \AttributeTok{nsim=}\DecValTok{499}\NormalTok{, }
                                      \AttributeTok{alternative=}\StringTok{"two.sided"}\NormalTok{, }
                                      \AttributeTok{iseed=}\DecValTok{1}\NormalTok{)}
\NormalTok{p\_values\_lmp }\OtherTok{\textless{}{-}}\NormalTok{ locm\_burglary\_perm[,}\DecValTok{5}\NormalTok{]}
\FunctionTok{sum}\NormalTok{(p\_values\_lmp }\SpecialCharTok{\textless{}} \FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Scale the count of burglary}
\NormalTok{grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{s\_burglary }\OtherTok{\textless{}{-}} \FunctionTok{scale}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{layer) }
\CommentTok{\# Creates p values for Bonferroni adjustment}
\NormalTok{grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{localmp\_bonf }\OtherTok{\textless{}{-}} \FunctionTok{p.adjust}\NormalTok{(p\_values\_lmp, }\StringTok{"bonferroni"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{lag\_s\_burglary }\OtherTok{\textless{}{-}} \FunctionTok{lag.listw}\NormalTok{(lw\_queen\_rs, grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{s\_burglary)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{s\_burglary)}
\FunctionTok{summary}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{lag\_s\_burglary)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-287-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(grid\_cc\_sf}\SpecialCharTok{$}\NormalTok{quad\_sig)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-290-1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# calculate rate per dwelling in whole study area}
\NormalTok{even\_rate\_per\_dwelling }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(burglary\_lsoa}\SpecialCharTok{$}\NormalTok{burglary) }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(burglary\_lsoa}\SpecialCharTok{$}\NormalTok{dwellings)}

\CommentTok{\# expected count for each LSOA times rate per number of dwellings}
\NormalTok{burglary\_lsoa }\OtherTok{\textless{}{-}}\NormalTok{ burglary\_lsoa }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{b\_expected =}\NormalTok{ dwellings }\SpecialCharTok{*}\NormalTok{ even\_rate\_per\_dwelling)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Get coordinates for centroids}
\NormalTok{lsoa\_centroid }\OtherTok{\textless{}{-}} \FunctionTok{st\_centroid}\NormalTok{(burglary\_lsoa) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{st\_coordinates}\NormalTok{(lsoa\_centroid)}
\CommentTok{\# Place the coordinates as vectors in our sf dataframe}
\NormalTok{burglary\_lsoa}\SpecialCharTok{$}\NormalTok{x }\OtherTok{\textless{}{-}}\NormalTok{ lsoa\_centroid[,}\DecValTok{1}\NormalTok{]}
\NormalTok{burglary\_lsoa}\SpecialCharTok{$}\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ lsoa\_centroid[,}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lsoas }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Observed =}\NormalTok{ burglary\_lsoa}\SpecialCharTok{$}\NormalTok{burglary,}
                   \AttributeTok{Expected =}\NormalTok{ burglary\_lsoa}\SpecialCharTok{$}\NormalTok{b\_expected,}
                    \AttributeTok{Population =}\NormalTok{ burglary\_lsoa}\SpecialCharTok{$}\NormalTok{dwellings,}
                    \AttributeTok{x =}\NormalTok{ burglary\_lsoa}\SpecialCharTok{$}\NormalTok{x,}
                    \AttributeTok{y =}\NormalTok{ burglary\_lsoa}\SpecialCharTok{$}\NormalTok{y)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pwtest }\OtherTok{\textless{}{-}} \FunctionTok{pottwhitt.test}\NormalTok{(Observed}\SpecialCharTok{\textasciitilde{}}\FunctionTok{offset}\NormalTok{(}\FunctionTok{log}\NormalTok{(Expected)),}
                         \FunctionTok{as}\NormalTok{(lsoas, }\StringTok{"data.frame"}\NormalTok{),}
                         \StringTok{"multinom"}\NormalTok{, }\DecValTok{999}\NormalTok{)}
\NormalTok{oplus }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(lsoas}\SpecialCharTok{$}\NormalTok{Observed)}
\DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{pnorm}\NormalTok{(pwtest}\SpecialCharTok{$}\NormalTok{t0, oplus }\SpecialCharTok{*}\NormalTok{ (oplus }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{), }\FunctionTok{sqrt}\NormalTok{(}\DecValTok{2} \SpecialCharTok{*} \DecValTok{100} \SpecialCharTok{*}\NormalTok{ oplus }\SpecialCharTok{*}\NormalTok{ (oplus }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-299-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyc\_burg\_df }\OtherTok{\textless{}{-}}\NormalTok{ sf\_nyc\_burg\_coords }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{unlist}\NormalTok{(nyc\_burg}\SpecialCharTok{$}\NormalTok{geometry), }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =}\NormalTok{ T)}
\NormalTok{nyc\_burg\_df }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(nyc\_burg\_df)}
\NormalTok{nyc\_burg\_df}\SpecialCharTok{$}\NormalTok{time }\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(nyc\_burg}\SpecialCharTok{$}\NormalTok{date\_single)}
\NormalTok{nyc\_burg\_df }\OtherTok{\textless{}{-}} \FunctionTok{rename}\NormalTok{(nyc\_burg\_df, }\AttributeTok{x =}\NormalTok{ V1, }\AttributeTok{y =}\NormalTok{ V2)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{results\_knox }\OtherTok{\textless{}{-}} \FunctionTok{NearRepeat}\NormalTok{(}\AttributeTok{x =}\NormalTok{ nyc\_burg\_df}\SpecialCharTok{$}\NormalTok{x, }
                     \AttributeTok{y =}\NormalTok{ nyc\_burg\_df}\SpecialCharTok{$}\NormalTok{y, }
                     \AttributeTok{time =}\NormalTok{ nyc\_burg\_df}\SpecialCharTok{$}\NormalTok{time,}
                     \AttributeTok{sds =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\DecValTok{100}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{400}\NormalTok{), }
                     \AttributeTok{tds =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{14}\NormalTok{, }\DecValTok{21}\NormalTok{),}
                     \AttributeTok{nrep =} \DecValTok{99}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(results\_knox)}
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-302-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-303-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-304-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{SOUTH\_f }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(ncovr}\SpecialCharTok{$}\NormalTok{SOUTH) }\CommentTok{\# specify this is a categorical variable}
\NormalTok{fit1\_90 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(HR90 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ RD90 }\SpecialCharTok{+}\NormalTok{ SOUTH\_f, }\AttributeTok{data=}\NormalTok{ncovr)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-312-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{res\_fit3 }\OtherTok{\textless{}{-}} \FunctionTok{residuals}\NormalTok{(fit3\_90)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{fitted\_fit3 }\OtherTok{\textless{}{-}} \FunctionTok{fitted}\NormalTok{(fit3\_90)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# because scale is made for matrices, we just need to get the first column using [,1]}
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{sd\_breaks }\OtherTok{\textless{}{-}} \FunctionTok{scale}\NormalTok{(ncovr}\SpecialCharTok{$}\NormalTok{res\_fit3)[,}\DecValTok{1}\NormalTok{] }
\CommentTok{\# this is equal to (ncovr$res\_fit1 {-} mean(ncovr$res\_fit1)) / sd(ncovr$res\_fit1)}
\FunctionTok{summary}\NormalTok{(ncovr}\SpecialCharTok{$}\NormalTok{sd\_breaks)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-316-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{direct }\OtherTok{\textless{}{-}}\NormalTok{ fit4\_70\_sdm.im}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{direct  }
\NormalTok{indirect }\OtherTok{\textless{}{-}}\NormalTok{ fit4\_70\_sdm.im}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{indirect }
\NormalTok{total }\OtherTok{\textless{}{-}}\NormalTok{ fit4\_70\_sdm.im}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{total    }
\NormalTok{direct}\SpecialCharTok{/}\NormalTok{total                     }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{res\_fit1 }\OtherTok{\textless{}{-}}\NormalTok{ fit1\_70}\SpecialCharTok{$}\NormalTok{residuals}
\FunctionTok{ggplot}\NormalTok{(ncovr, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ res\_fit1, }\AttributeTok{colour =} \FunctionTok{as.factor}\NormalTok{(SOUTH))) }\SpecialCharTok{+} 
  \FunctionTok{geom\_density}\NormalTok{() }
\end{Highlighting}
\end{Shaded}

\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-333-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{NORTH }\OtherTok{\textless{}{-}} \FunctionTok{recode}\NormalTok{(ncovr}\SpecialCharTok{$}\NormalTok{SOUTH, }\StringTok{\textasciigrave{}}\AttributeTok{1}\StringTok{\textasciigrave{}} \OtherTok{=} \DecValTok{0}\NormalTok{, }\StringTok{\textasciigrave{}}\AttributeTok{0}\StringTok{\textasciigrave{}} \OtherTok{=} \DecValTok{1}\NormalTok{)}
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{ONE }\OtherTok{\textless{}{-}} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chow.test }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(rest,unrest)}
\NormalTok{\{}
\NormalTok{er }\OtherTok{\textless{}{-}} \FunctionTok{residuals}\NormalTok{(rest)}
\NormalTok{eu }\OtherTok{\textless{}{-}} \FunctionTok{residuals}\NormalTok{(unrest)}
\NormalTok{er2 }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(er}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{eu2 }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(eu}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{k }\OtherTok{\textless{}{-}}\NormalTok{ rest}\SpecialCharTok{$}\NormalTok{rank}
\NormalTok{n2k }\OtherTok{\textless{}{-}}\NormalTok{ rest}\SpecialCharTok{$}\NormalTok{df.residual }\SpecialCharTok{{-}}\NormalTok{ k}
\NormalTok{c }\OtherTok{\textless{}{-}}\NormalTok{ ((er2 }\SpecialCharTok{{-}}\NormalTok{ eu2)}\SpecialCharTok{/}\NormalTok{k) }\SpecialCharTok{/}\NormalTok{ (eu2 }\SpecialCharTok{/}\NormalTok{ n2k)}
\NormalTok{pc }\OtherTok{\textless{}{-}} \FunctionTok{pf}\NormalTok{(c,k,n2k,}\AttributeTok{lower.tail=}\ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{list}\NormalTok{(c,pc,k,n2k)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{spatialchow.test }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(rest,unrest)}
\NormalTok{\{}
\NormalTok{lrest }\OtherTok{\textless{}{-}}\NormalTok{ rest}\SpecialCharTok{$}\NormalTok{LL}
\NormalTok{lunrest }\OtherTok{\textless{}{-}}\NormalTok{ unrest}\SpecialCharTok{$}\NormalTok{LL}
\NormalTok{k }\OtherTok{\textless{}{-}}\NormalTok{ rest}\SpecialCharTok{$}\NormalTok{parameters }\SpecialCharTok{{-}} \DecValTok{2}
\NormalTok{spchow }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}} \FloatTok{2.0} \SpecialCharTok{*}\NormalTok{ (lrest }\SpecialCharTok{{-}}\NormalTok{ lunrest)}
\NormalTok{pchow }\OtherTok{\textless{}{-}} \FunctionTok{pchisq}\NormalTok{(spchow,k,}\AttributeTok{lower.tail=}\ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{list}\NormalTok{(spchow,pchow,k)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# map residuals}
\NormalTok{ncovr}\SpecialCharTok{$}\NormalTok{resids }\OtherTok{\textless{}{-}} \FunctionTok{residuals}\NormalTok{(model)}
\FunctionTok{qtm}\NormalTok{(ncovr, }\AttributeTok{fill =} \StringTok{"resids"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-344-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gwr\_bandwidth }\OtherTok{\textless{}{-}} \FunctionTok{gwr.sel}\NormalTok{(HR70 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ RD70 }\SpecialCharTok{+}\NormalTok{ PS70 }\SpecialCharTok{+}\NormalTok{ MA70 }\SpecialCharTok{+}\NormalTok{ DV70 }\SpecialCharTok{+}\NormalTok{ UE70, }
                         \AttributeTok{data =}\NormalTok{ ncovr, }
                         \AttributeTok{coords =}\NormalTok{ ncovr}\SpecialCharTok{$}\NormalTok{cent\_coords, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gwr\_model }\OtherTok{=} \FunctionTok{gwr}\NormalTok{(HR70 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ RD70 }\SpecialCharTok{+}\NormalTok{ PS70 }\SpecialCharTok{+}\NormalTok{ MA70 }\SpecialCharTok{+}\NormalTok{ DV70 }\SpecialCharTok{+}\NormalTok{ UE70, }\AttributeTok{data =}\NormalTok{ ncovr,}
                \AttributeTok{coords =}\NormalTok{ ncovr}\SpecialCharTok{$}\NormalTok{cent\_coords,}
                \AttributeTok{adapt=}\NormalTok{gwr\_bandwidth,}
                \AttributeTok{hatmatrix=}\ConstantTok{TRUE}\NormalTok{,}
                \AttributeTok{se.fit=}\ConstantTok{TRUE}\NormalTok{) }

\NormalTok{gwr\_model}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gwr\_results }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(gwr\_model}\SpecialCharTok{$}\NormalTok{SDF)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-346-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-347-1.pdf}
...
\includegraphics{crime_mapping_files/figure-latex/unnamed-chunk-348-1.pdf}
