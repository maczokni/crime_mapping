...
In this chapter we explored the use of binning points into hexbins and rectangular grids, as well as transforming polygons in order to enhanche the legibility of your maps. For some more information on binning see \protect\hyperlink{ref-Johnson_2011}{Johnson} (\protect\hyperlink{ref-Johnson_2011}{n.d.}). For transforming polygons, read \protect\hyperlink{ref-Tobler_2004}{Tobler} (\protect\hyperlink{ref-Tobler_2004}{2004}) and \protect\hyperlink{ref-Nusrat_2016}{Nusrat and Kobourov} (\protect\hyperlink{ref-Nusrat_2016}{2016}). We can also suggest a read of (\protect\hyperlink{ref-Langton_2018}{\textbf{Langton\_2018?}}) and check out this video from SAGE methods \protect\hyperlink{ref-Solymosi_2021}{Solymosi} (\protect\hyperlink{ref-Solymosi_2021}{n.d.}).
...
---------. n.d. {``Map Evaluation Guidelines.''} \url{http://downloads.esri.com/MappingCenter2007/arcGISResources/more/MapEvaluationGuidelines.pdf}.
...
Johnson, Zachary Forest. n.d. {``Hexbins!''} \url{http://indiemaps.com/blog/2011/10/hexbins/}.
...
Pebesma, Edzer, and Roger Bivand. n.d. {``Spatial Data Science with Applications in r.''} \url{https://keen-swartz-3146c4.netlify.app/}.
...
Solymosi, Reka. n.d. {``Minimizing Misrepresentation in Spatial Data Visualizations.''} \url{https://www.doi.org/10.4135/9781529774047}.
...
Tufte, Edward. 2001. {``The Visual Display of Quantitative Information.''} Cheshire: Graphic Press.--2001.--213 p.
...
Yutani, Hiroaki. n.d. \url{https://yutani.rbind.io/post/geom-sf-text-and-geom-sf-label-are-coming/}.
