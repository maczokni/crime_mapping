...
\NormalTok{leave\_breaks }\OtherTok{\textless{}{-}} \FunctionTok{quantile}\NormalTok{(eu\_sf}\SpecialCharTok{$}\NormalTok{Pct\_Leave, }
                         \AttributeTok{probs =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{, }\AttributeTok{by =} \DecValTok{1}\SpecialCharTok{/}\DecValTok{3}\NormalTok{), }\CommentTok{\# vector of probabilities}
                         \AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{, }\CommentTok{\# remove NAs before computing quantiles}
                         \AttributeTok{names=}\ConstantTok{TRUE}\NormalTok{, }\CommentTok{\# result will have names attribute}
                         \AttributeTok{include.lowest=}\ConstantTok{TRUE}\NormalTok{) }\CommentTok{\# include value equal to }
                                              \CommentTok{\# the lowest ‘breaks’ value }
\end{Highlighting}
\end{Shaded}
