...
```{r, fig.cap='Distribution of residuals by study region (South v North)'}
...
```{r, warning=FALSE, message=FALSE, fig.cap='Map of model residuals'}
...
```{r, fig.cap='Map of local R-square value for each county'}
...
```{r, message=FALSE, warning=FALSE, fig.cap='Map of coefficient for resource deprivation value for each county'}
...
```{r, message=FALSE, warning=FALSE, fig.cap='Map of standard error for resource deprivation value for each county'}
