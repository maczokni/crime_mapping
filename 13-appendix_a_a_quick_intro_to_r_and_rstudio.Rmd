...
```{r, echo=FALSE, fig.cap="Find Tools > Global options", fig.alt="A partial screen capture of the R studio desktop application, with a drop-down menu from the top bar open. The 'Tools' menu has been selected, and among the options from it, 'Global Options...' is highlighted."}
