...
```{r, echo=FALSE, fig.cap="Navigate to File > New File> R Script to open script pane", fig.alt="The RStudio desktop application now has a drop-down menu from the top bar open. The 'File' menu has been selected, and among the options from it, the 'New File' submenu has been opened. Within this submenu, 'R Script' is highlighted."}
...
```{r, echo=FALSE, fig.cap="Find Tools > Global options", fig.alt="A partial screen capture of the RStudio desktop application, with a drop-down menu from the top bar open. The 'Tools' menu has been selected, and among the options from it, 'Global Options...' is highlighted."}
