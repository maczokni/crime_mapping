...
There are a number of tools that have been developed to detect local clusters. In crime analysis, for example, is common the use of the local $Gi^*$ statistic, which is a type of a **local indicator of spatial autocorrelation**. Another popular LISA is the local Moran´s $I$. 
