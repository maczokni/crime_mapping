...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.width=6, fig.cap = 'Layers of ggplot'}
...
```{r, echo = FALSE, message=FALSE, warning=FALSE, fig.cap='Final plot'}
...
```{r, fig.cap='Data layer', fig.height=2}
library(ggplot2)
...
```{r, fig.cap='Geometry layer', fig.height=2}
...
```{r, fig.cap='Annotations layer', fig.height=2}
...
```{r, fig.cap='Customise themes', fig.height=2}
...
```{r, fig.cap='Additional layers', fig.height=2}
...
```{r, fig.cap='Customise colour', fig.height=2}
...
```{r, fig.cap='geom_sf for plotting', fig.height=2}
...
```{r, message=FALSE, fig.cap='Adding a basemap', fig.height=2}
...
```{r, echo = FALSE, message=FALSE, warning=FALSE, results='hide', fig.cap='Hierarchy of Census Geographies in the UK', fig.height=2}
...
```{r, fig.cap="Plot of Manchester's LSOAs", fig.height=2}
