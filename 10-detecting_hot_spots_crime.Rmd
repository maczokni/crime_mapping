...
```{r, fig.cap='Raster map of burglary across Manchester'}
...
```{r, warning = FALSE, message = FALSE, fig.cap='Raster map of burglary in City Centre only'}
...
```{r, message=FALSE, warning=FALSE, fig.cap='Map of z-scores and of significant hot spots of burglary'}
...
```{r, fig.cap="Moran's scatterplot for burglary in Manchester"}
...
```{r, warning=FALSE, message=FALSE, fig.cap='Map to visualise high leverage (hat value) areas'}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.cap='Quadrants of a Moran scatterplot'}
library(ggplot2)
...
```{r, warning=FALSE,message=FALSE, fig.cap="Significant clusters from local Moran's I"}
...
```{r, fig.cap="Difference in results between Openshaw's GAM and Kulldorf scan statistics"}
...
```{r, fig.height=3, fig.cap='Results of the Knox test'}
