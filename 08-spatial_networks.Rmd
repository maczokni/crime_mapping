...
Let's move across the Ocean over to the UK. To be able to do this, we take open data from the British Transport Police, a national special police force that polices railways and light-rail systems in England, Wales and Scotland. Specifically, we will focus on crimes recorded by BTP on the London Underground system. 
...
We now have our crimes per meter score. We can then map this to create a map of **hot routes**.
...
And, as noted above, @Rakshit_2019 developed a fast algorithm, using a convolution method, that is particularly helpful with large datasets. The analysis of the authors suggest this estimator "is consistent, and its statistical efficiency is only slightly suboptimal" [@Rakshit_2019]. 
