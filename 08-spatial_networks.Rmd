...
The strength of this approach is to focus in on one area of interest. Here let's choose Telegraph Road. It is a long street which runs through the town centre. To subset it, we can use the names provided by the volunteers of Open Street Map, available in the `` column: 
...
Here we can see there may be some differences between winter and summer, but it is unclear how much. 
...
Let's plot the summer shoplifting incidents
