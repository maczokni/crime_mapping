...
# plot
plot(heswall_roads_linnet, style = "none", main = "Heswall")
...
ggplot() + 
  geom_sf(data = heswall_lines) + 
  geom_sf(data = heswall_shoplifting, colour = "red") + 
  geom_sf(data = heswall_bb, colour = "blue", fill = NA) + 
  theme_void()
...
# calculate density
d100 <- density.lpp(asb_lpp, 100, finespacing=FALSE)
# plot
plot(d100)
...
heswall_tc <- st_as_sf(heswall_tc, 
...
ggplot() + 
  geom_sf(data = heswall_lines) + 
  geom_sf(data = heswall_shoplifting, col = "red") + 
  geom_sf(data = heswall_tc, col = "blue", fill = NA) + 
  theme_void()

```

<!-- HERE NOW, FOCUS ON TOWN CENTRE, DO HOT ROUTES, FOCUS ON ST, DO ST PROFILE -->
