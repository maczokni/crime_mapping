...
### Let´s look at the data: how far are police stations in Madrid?

To illustrate how to measure distance we will download data from the city of Madrid in Spain. Specifically we will obtain two geojson files from the web, one with the location of national police stations in Spain and another with the administrative boundary for the city of Madrid.

```{r}
comisarias <- st_read("https://raw.githubusercontent.com/maczokni/crime_mapping/master/data/comisarias.geojson")
madrid <- st_read("https://raw.githubusercontent.com/maczokni/crime_mapping/master/data/madrid.geojson") 

st_write(police, "C:/crime_mapping/data/police.csv", layer_options = "GEOMETRY=AS_XY")
library(readr)
m <- read_csv("C:/crime_mapping/data/police.csv")

library(dplyr)
n <- select(m, NOMBRE, X, Y)
write_csv(n, "C:/crime_mapping/data/nationalpolice.csv")
