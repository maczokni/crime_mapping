...
#### Build a query: where are police stations in Madrid?
...
```{r}
police <- osmdata_sf(query)
police
```

As we can see this produces various spatial objets. We are only interested in the points, which represent the location of these police stations.
