...
geo <- sf_geojson(manchester_crime_lsoa)
st_write(manchester_crime_lsoa, "man_crime_lsoa", driver = "GeoJSON")
shp_name <- "data/BoundaryData/manchester_crime_lsoa.shp"
manchester_crime_lsoa <- st_read(shp_name)
manchester__crime_lsoa <- st_read("https://github.com/maczokni/crime_mapping/raw/master/data/man_crime_lsoa")
